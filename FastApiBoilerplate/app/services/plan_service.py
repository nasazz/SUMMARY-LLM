from app.domain.plans.plan_models import ProductionPlan
from app.domain.plans.plan_schemas import ProductionPlanCreate, ProductionPlanResponse
from app.infrastructure.repository import GenericRepository
from app.infrastructure.uow import UnitOfWork
from app.core.result import Result
from fastapi import Depends
from sqlalchemy.orm import Session
from app.infrastructure.database import get_db
from app.domain.common_schemas import (
    PaginatedResponse,
